...
## Converting raw data A103
```{r}
A103_raw <- read.table("A103_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
A103 <- A103_raw[,-c(2:5)] #cut out unnecessary columns
A103 <- A103[,-c(4:8)] #cut out unnecessary columns
names(A103) <- c("Sample_ID", "Marker", "Allele") #rename columns
A103 = A103 %>% na.omit() #omit all NAs
A103[A103 == "Sample"] <- NA #convert sample to NAs so they can be omitted
A103 = A103 %>% na.omit() #omit NAs again
...
#A103 <- A103[,c(4,2,3)] #Reorder columns
#A103 <- A103[, -c(4)] #Remove Sample column
View(A103)

```

## Converting raw data A103 new
```{r}
A103_wisraw <- read.table("A103_wis_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
A103 <- A103_wisraw[,-c(2:5)] #cut out unnecessary columns
A103 <- A103[,-c(4:8)] #cut out unnecessary columns
names(A103) <- c("Sample_ID", "Marker", "Allele") #rename columns
A103 = A103 %>% na.omit() #omit all NAs
A103[A103 == "Sample"] <- NA #convert sample to NAs so they can be omitted
...
## Converting raw data A115
```{r}
A115_raw <- read.table("A115_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
A115 <- A115_raw[,-c(2:5)] #cut out unnecessary columns
A115 <- A115[,-c(4:8)] #cut out unnecessary columns
names(A115) <- c("Sample_ID", "Marker", "Allele") #rename columns
A115 = A115 %>% na.omit() #omit all NAs
...
View(A115)
#write.table(A115, "A115_converted", sep = ",")
```


## Converting raw data C1
```{r}
C1_raw <- read.table("C1_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C1 <- C1_raw[,-c(2:5)] #cut out unnecessary columns
C1 <- C1[,-c(4:8)] #cut out unnecessary columns
names(C1) <- c("Sample_ID", "Marker", "Allele") #rename columns
C1 = C1 %>% na.omit() #omit all NAs
...
## Converting raw data C1 new
```{r}
C1_raw <- read.table("C1_wis_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C1 <- C1_raw[,-c(2:5)] #cut out unnecessary columns
C1 <- C1[,-c(4:8)] #cut out unnecessary columns
names(C1) <- c("Sample_ID", "Marker", "Allele") #rename columns
C1 = C1 %>% na.omit() #omit all NAs
...
## Converting raw data C6
```{r}
C6_raw <- read.table("C6_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C6 <- C6_raw[,-c(2:5)] #cut out unnecessary columns
C6 <- C6[,-c(4:8)] #cut out unnecessary columns
names(C6) <- c("Sample_ID", "Marker", "Allele") #rename columns
C6 = C6 %>% na.omit() #omit all NAs
...
## Converting raw data C6 new
```{r}
C6_raw <- read.table("C6_wis_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C6 <- C6_raw[,-c(2:5)] #cut out unnecessary columns
C6 <- C6[,-c(4:8)] #cut out unnecessary columns
names(C6) <- c("Sample_ID", "Marker", "Allele") #rename columns
C6 = C6 %>% na.omit() #omit all NAs
...
## Converting raw data C105
```{r}
C105_raw <- read.table("C105_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C105 <- C105_raw[,-c(2:5)] #cut out unnecessary columns
C105 <- C105[,-c(4:8)] #cut out unnecessary columns
names(C105) <- c("Sample_ID", "Marker", "Allele") #rename columns
C105 = C105 %>% na.omit() #omit all NAs
...
## Converting raw data C105 new
```{r}
C105_raw <- read.table("C105_wis_raw.csv", sep = ",", na.strings = c("", "NA")) #read in data
C105 <- C105_raw[,-c(2:5)] #cut out unnecessary columns
C105 <- C105[,-c(4:8)] #cut out unnecessary columns
names(C105) <- c("Sample_ID", "Marker", "Allele") #rename columns
C105 = C105 %>% na.omit() #omit all NAs
