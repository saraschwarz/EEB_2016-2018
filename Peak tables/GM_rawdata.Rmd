...
names(A120) <- c("Sample_ID", "Allele") #rename columns
...
names(C125) <- c("Sample_ID", "Allele") #rename columns
...
names(D4) <- c("Sample_ID", "Allele") #rename columns
...
names(D10) <- c("Sample_ID", "Allele") #rename columns
...
names(D106) <- c("Sample_ID", "Allele") #rename columns
...
names(D113) <- c("Sample_ID", "Allele") #rename columns
...
names(D114) <- c("Sample_ID", "Allele") #rename columns
...
names(D119) <- c("Sample_ID", "Allele") #rename columns
...
names(D125) <- c("Sample_ID", "Allele") #rename columns
...
names(A120_wis) <- c("Sample_ID", "Allele") #rename columns
...
names(D4_wis) <- c("Sample_ID", "Allele") #rename columns
...
names(D10_wis) <- c("Sample_ID", "Allele") #rename columns
...
names(D106_wis) <- c("Sample_ID", "Allele") #rename columns
